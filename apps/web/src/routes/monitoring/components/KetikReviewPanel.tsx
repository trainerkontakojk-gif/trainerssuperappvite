                ...
                {[
                  {
                    ...
                    score: data.scores?.empathy ?? 0,
                    icon: Heart,
                    description:
                      "Kemampuan memahami & merespons perasaan konsumen",
                  },
                  {
                    label: "Probing",
                    score: data.scores?.probing ?? 0,
                    icon: Zap,
                    description:
                      "Kemampuan menggali informasi & kebutuhan konsumen",
                  },
                  ...(data.scores?.resolution !== undefined
                    ? [
                        {
                          label: "Resolusi",
                          score: data.scores.resolution,
                          icon: Target,
                          description:
                            "Kejelasan solusi, langkah tindak lanjut, & kelengkapan",
                        },
                      ]
                    : []),
                  {
                    label: "Tata Tulis",
                    score: data.scores?.typo ?? 0,
                    icon: AlertTriangle,
                    description:
                      "Kualitas penulisan: ejaan, tata bahasa, kerapian",
                  },
                  {
                    label: "Kepatuhan",
                    score: data.scores?.compliance ?? 0,
                    icon: Award,
                    description:
                      "Kepatuhan terhadap prosedur & etika komunikasi",
                  },
                ].map((card) => {
            ...
            <div className="bg-primary/5 rounded-[1.5rem] p-6 border border-primary/10 flex flex-col md:flex-row items-start justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div
                    className={`text-3xl font-black ${getScoreGrade(data.scores?.final || 0).color}`}
                  >
                    {data.scores?.final || 0}
                  </div>
                  <div
                    className={`text-[11px] font-bold ${getScoreGrade(data.scores?.final || 0).color} mt-0.5`}
                  >
              ...
              <div className="flex flex-col gap-1.5 text-right">
                <div className="text-sm text-foreground/80 font-medium max-w-[360px]">
                  Performa dinilai dari: <strong>Empati & Komunikasi</strong>,{" "}
                    ...
                    {data.typos.map((typo) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-xs font-bold text-chart-green">
