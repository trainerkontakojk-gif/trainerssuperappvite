  ...
  const exportOptions = [
    {
      ...
      label: "Excel (.xlsx)",
      desc: "Export data ke format Excel dengan semua kolom",
      action: exportExcel,
    ...
    },
    {
      ...
      icon: FileText,
      label: "CSV (.csv)",
      desc: "Export data ke format CSV untuk analisis lanjutan",
      action: exportCSV,
      color: "text-blue-600",
      bg: "bg-blue-100",
    },
    ...
    <div className="max-w-2xl space-y-6">
      <div>
        ...
        <h2 className="text-lg font-bold text-gray-900 mt-1">
          Ekspor Data — {batchName}
        </h2>
        <p className="text-sm text-gray-500">
          {peserta.length} peserta tersedia untuk diexport.
        </p>
      </div>
