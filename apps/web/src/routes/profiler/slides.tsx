        ...
        <div className="rounded-xl border bg-white shadow-sm overflow-hidden">
          <div className="grid md:grid-cols-[300px_1fr] min-h-[400px]">
            ...
            <div className="bg-gray-50 p-6 border-r flex flex-col items-center text-center">
              ...
              <span className="inline-flex rounded-full bg-amber-50 px-3 py-1 text-xs font-medium text-amber-700 mt-2">
                {p.jabatan}
              </span>
            ...
            <div className="p-6 space-y-6">
              <div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="text-gray-500">NIP OJK:</span>
                    <br />
                    <span className="text-gray-900">{p.nik_ojk || "-"}</span>
                  </div>
                  <div>
                    <span className="text-gray-500">Email:</span>
                    <br />
                    <span className="text-gray-900">{p.email_ojk || "-"}</span>
                  </div>
                  <div>
                    <span className="text-gray-500">Telepon:</span>
                    <br />
                    <span className="text-gray-900">{p.no_telepon || "-"}</span>
                  </div>
                  <div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <br />
                    <span className="text-gray-900">{p.pendidikan || "-"}</span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <br />
                    <span className="text-gray-900">{p.agama || "-"}</span>
                  </div>
                </div>
              </div>
