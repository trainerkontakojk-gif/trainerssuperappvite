          ...
          <div className="relative z-10 flex flex-col min-h-screen">
            ...
            <section className="relative px-6 pt-24 pb-16 lg:px-8 lg:pt-32">
              <div className="mx-auto max-w-7xl text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <p className="mx-auto max-w-2xl text-lg leading-8 text-muted-foreground mb-10">
                  Trainers SuperApp menyatukan semua kebutuhan operasional
                  Anda—mulai dari simulasi chat, email, telepon, profiling,
                  hingga analitik QA. Satu ruang kerja yang terpusat agar tim
              ...
              <div className="mx-auto max-w-7xl">
                <div className="text-center mb-16">
                  <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">
                    Satu tempat untuk berbagai kebutuhan.
                  </h2>
                  <p className="text-muted-foreground max-w-2xl mx-auto">
                    Gonta-ganti tugas jadi jauh lebih mulus dengan desain
                    antarmuka yang seragam di tiap modul.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5 h-full">
                  {productModules.map((module, idx) => (
                    ...
                    >
                      <div
                        className={`mb-6 flex h-12 w-12 items-center justify-center rounded-xl ${module.accentSoftClassName} ${module.accentClassName} transition-colors group-hover:bg-primary group-hover:text-primary-foreground`}
                      >
                      ...
                      <p className="text-xs leading-relaxed text-muted-foreground mt-auto">
                        {module.id === "ketik" &&
                          "Simulasi interaktif untuk melatih penanganan chat pelanggan."}
                        {module.id === "pdkt" &&
                          "Penyusunan penulisan email dengan draf terpandu dan asisten AI cerdas."}
                        {module.id === "telefun" &&
                          "Skenario penanganan telepon berdasarkan kasus interaksi sebenarnya di lapangan."}
                        {module.id === "profiler" &&
                          "Sistem pengadaan data operasional dari rekam performa histori para agen."}
                        {module.id === "qa-analyzer" &&
                          "Pantauan analitikal untuk visibilitas hasil peringkat kualitas dari penilaian QA."}
                      </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                  <div className="lg:col-span-1">
                    <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-6">
                      Mengapa platform terpusat?
                    </h2>
                    <p className="text-muted-foreground text-lg mb-8">
                      Kami paham padatnya jadwal tim Anda. Dengan platform
                      terpusat ini, proses operasional jadi lebih ramping agar
                      Anda bisa fokus membantu tim berkembang.
                    </p>
                  ...
                  <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      ...
                      <div
                        key={item.title}
                        className="p-8 rounded-3xl bg-muted/30 border border-border/40 hover:bg-muted/50 transition-colors"
                      >
            ...
            <section className="relative overflow-hidden py-24 px-6 lg:px-8">
              ...
              <div className="relative mx-auto max-w-7xl text-center">
                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-6">
                  Siap beralih ke cara kerja yang lebih baik?
                </h2>
                <p className="text-muted-foreground text-lg mb-10 max-w-2xl mx-auto">
                  Sederhanakan alur pelatihan dan pantau target operasional tim
                  Anda dalam satu layar.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <FooterAuthActions />
                </div>
              ...
              <div className="mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-between gap-6 text-muted-foreground">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-xs tracking-tight">
                    © 2026 Trainers SuperApp — Fajar Abd
                  </p>
                </div>
