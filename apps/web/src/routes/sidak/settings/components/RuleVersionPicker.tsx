...
export function RuleVersionPicker({
  ...
  return (
    <aside className="w-full lg:w-80 border-b lg:border-b-0 lg:border-r border-border bg-surface/50 overflow-y-auto">
      <div className="p-4 space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-[11px] font-semibold uppercase tracking-wide text-muted-foreground px-1">Riwayat Versi</p>
          {versionsLoading ? (
            <div className="space-y-2">
              {[1, 2, 3].map((i) => (
