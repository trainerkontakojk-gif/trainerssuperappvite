    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Buat laporan data temuan QA atau generate laporan otomatis dengan AI.
        </p>
      </header>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Link
          ...
          className="group block rounded-xl border bg-white p-8 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all"
        >
          ...
          <p className="mt-2 text-sm text-gray-500 leading-relaxed">
            Laporan berbasis database dengan filter lengkap — pilih layanan,
            periode, agent, atau tim. Export ke Excel.
          </p>
        ...
        {/* AI Report Card */}
        <div
          className="group block rounded-xl border bg-white p-8 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all cursor-pointer"
        ...
        >
          ...
          <p className="mt-2 text-sm text-gray-500 leading-relaxed">
            Laporan otomatis dengan AI — pilih model, filter data, dan dapatkan
            laporan dalam format HTML atau DOCX.
          </p>
