      ...
      <div className="space-y-6 pb-10 mt-2">
        ...
        <div className="bg-card border border-border rounded-xl overflow-hidden relative">
          ...
          <div className="p-6 space-y-5">
            <div>
              <label className="block text-sm font-medium text-muted-foreground uppercase tracking-wide mb-1.5">Nama Karakter / Tipe</label>
              <input
            ...
            <div>
              <label className="block text-sm font-medium text-muted-foreground uppercase tracking-wide mb-1.5">Tingkat Kesulitan</label>
            ...
            <div>
              <label className="block text-sm font-medium text-muted-foreground uppercase tracking-wide mb-1.5">Deskripsi / Prompt AI</label>
              <textarea
            ...
            <div className="flex justify-end gap-2.5 pt-4 border-t border-border">
              <button onClick={handleCancelConsumerForm} className="px-4 py-2 rounded-md text-sm font-medium text-muted-foreground hover:bg-foreground/5 transition-colors cursor-pointer">Batal</button>
              <button
                onClick={handleSaveConsumer}
                disabled={!consumerForm.draft.name || !consumerForm.draft.description}
                className="px-5 py-2 bg-foreground text-background rounded-md text-sm font-medium hover:opacity-90 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Simpan
              </button>
            </div>
  ...
  return (
    <div className="space-y-6 pb-10 mt-2">
      ...
      <div className="bg-primary/5 border border-primary/20 p-4 rounded-xl flex gap-4 items-start">
        ...
        <div>
          <h4 className="font-semibold text-foreground text-sm mb-0.5">Tips Simulasi</h4>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        >
          ...
          <p className="text-sm text-muted-foreground font-medium leading-relaxed mt-1.5">
              ...
              <div className="flex justify-between items-start mb-2 gap-2">
                <div className="flex flex-col gap-1 min-w-0">
                  ...
                  <div className="flex gap-2 flex-wrap mt-0.5">
                    <span
                      className={`text-sm px-2 py-0.5 rounded font-bold uppercase tracking-wider border ${badgeClass}`}
                    >
                      {c.difficulty}
                    </span>
                  </div>
