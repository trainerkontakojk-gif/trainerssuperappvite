...
function hasLegacyPdktShape(value: JsonRecord): boolean {
  return LEGACY_PDKT_KEYS.some((key) => Object.prototype.hasOwnProperty.call(value, key));
}
...
export function writePdktSettings(existingSettings: unknown, nextSettings: JsonRecord): JsonRecord {
  return {
