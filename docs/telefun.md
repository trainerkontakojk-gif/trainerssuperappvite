...
- Dua acceptance production pada kontrak dual-owner sebelumnya gagal dengan `conversation_already_has_active_response`; watchdog menutup flags, menghentikan Telefun, dan menguras durable boundary tanpa mengubah Gemini. Repair single-owner setelah kegagalan kedua masih provider-free/unit/fake-browser dan belum mempunyai live production PASS. Mini, fallback policy, parity lintas browser, serta keputusan deprecation OpenAI WebSocket tetap deferred; Gemini dan legacy OpenAI WebSocket tidak berubah.
