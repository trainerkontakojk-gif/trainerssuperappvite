...
2. Verifikasi branch/status. Application runtime yang relevan adalah Web `b7c5ed8` serta API/Telefun `f8d9cec`; jangan kembali memakai `2b2545b` sebagai current candidate.
