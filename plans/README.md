...
Lane C/D persisted plans live in [`plans/markdown/`](markdown/) and are tracked in Git. The git-ignored `plan/markdown/` directory is a legacy local archive; do not add new plans there.
