...
196.  **Landing Page Hero Stack Cards** — Added interactive hero stack cards to landing page — visual previews of KETIK (chat bubbles), PDKT (email draft), and TELEFUN (call interface) arranged as stacked glassmorphism cards with hover animation and dark mode support. 2 files modified. (DONE)
